...
const HomePage: React.FC = () => {
    ...
    const generateChartData = () => {
        ...
        return {
            ...
            datasets: [
                {
                    label: `${result.alloy_name} Stress-Strain Curve`,
                    data: data,
            ...
            <table className={styles.table}>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{result.density} g/cm³</td>
                    </tr>
                    <tr>
                        <td><strong>Melting Point</strong></td>
                        <td>{result.melting_point} °C</td>
                    </tr>
                    <tr>
                        <td><strong>Tensile Strength</strong></td>
                        <td>{result.tensile_strength} MPa</td>
                    </tr>
                </tbody>
            </table>
        );
    ...
    return (
        <div className={styles.container}>
            ...
            {result && scenario === 'plot' && (
                <div className={styles.resultContainer}>
                    <h2>Stress-Strain Curve for {result.alloy_name}</h2>
            ...
            {result && scenario === 'properties' && (
                <div className={styles.resultContainer}>
                    <h2>Material Properties for {result.alloy_name}</h2>
